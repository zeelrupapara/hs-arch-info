...
6. [Reports](#reports)
7. [Step0 Baseline](#step0_baseline)
...
### Overview
Additional docs for the APIs,Database,Discovery,Enviorment,Reports,Security Access, which will provide all api end point request with latency , error logs , access users

### Structure

| Directory | Description |
|-----------|-------------|
| [APIs](Step0_Baseline/APIs/) | API calls used, including endpoints, latency, and error logs |
| [Database](Step0_Baseline/Database/) | Accounts audit and current policies |
| [Discovery](Step0_Baseline/Discovery/) | Third-party services, timelines, user workflows, and images |
| [Enviornment](Step0_Baseline/Enviornment/) | Environment configuration details |
| [Reports](Step0_Baseline/Reports/) | Logs from various services (vfxcore, vfxdata, vfxmarket, vfxserver) including error summaries |
| [Security_Access](Step0_Baseline/Security_Access/) | Access lists and vendor information |
...
| PDF Export | [PDF Reports](evidence/report/pdf/Account%20Statement.pdf) | Generated daily performance report. Available files: Account Group.pdf, Account Statement.pdf, History - Deals.pdf, History - order.pdf, History - Position.pdf, Journal.pdf, Money Transaction.pdf, Online Sessions.pdf, Trade Account.pdf |
| HTML | [HTML Reports](evidence/report/HTML/Online%20Sessions.png) | Visual dashboard showing report status and generation history. Available files: Account Group.png, Account Statement.png, History - Deal.png, History - Order.png, History - Position.png, Journal.png, Money Transaction.png, Online Sessions.png, Trade Account.png |
