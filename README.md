...
| Evidence Type | File / Link | Description |
|---------------|------------|-------------|
| Sample Report (CSV) | [CSV Reports](evidence/report/CSV/hi) | Example of CAT regulatory report with header fields. Available files: Account Group.csv, Account Statement.csv, History - Deals.csv, History - Order.csv, History - Position.csv, Journal.csv, Money Transaction.csv, Online Sessions.csv, Trade Account.csv |
